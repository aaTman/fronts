...
def choose_activation_layer(activation: str):
    ...
    Returns
    -------
    activation_layer: tf.keras.layers.Activation, tf.keras.layers.PReLU, tf.keras.layers.LeakyReLU, or any layer from activations
        Activation layer.
    """
    ...
    if activation == "elliott":
        activation_layer = activations.Elliott
    elif activation == "gaussian":
        activation_layer = activations.Gaussian
    elif activation == "gcu":
        activation_layer = activations.GCU
    elif activation == "hexpo":
        activation_layer = activations.Hexpo
    elif activation == "isigmoid":
        activation_layer = activations.ISigmoid
    elif activation == "leaky_relu":
        activation_layer = getattr(layers, "LeakyReLU")
    elif activation == "lisht":
        activation_layer = activations.LiSHT
    elif activation == "prelu":
        activation_layer = getattr(layers, "PReLU")
    elif activation == "psigmoid":
        activation_layer = activations.PSigmoid
    elif activation == "ptanh":
        activation_layer = activations.PTanh
    elif activation == "ptelu":
        activation_layer = activations.PTELU
    elif activation == "resech":
        activation_layer = activations.ReSech
    elif activation == "smelu":
        activation_layer = activations.SmeLU
    elif activation == "snake":
        activation_layer = activations.Snake
    elif activation == "srs":
        activation_layer = activations.SRS
    elif activation == "stanh":
        activation_layer = activations.STanh
