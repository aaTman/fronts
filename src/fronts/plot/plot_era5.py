...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Base directory for the ERA5 netcdf files.",
    )
    parser.add_argument(
        "--plot_outdir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="Valid time with format YYYY-MM-DD-HH.",
    )
    parser.add_argument("--variable", type=str, required=True, help="Variable to plot.")
    parser.add_argument(
        "--pressure_level", type=str, required=True, help="Pressure level of interest."
    )
    parser.add_argument(
        "--plot_kwargs",
        type=str,
    ...
    ds = xr.open_dataset(nc_file).sel(pressure_level=args["pressure_level"])[
        args["variable"]
    ]

    fig, ax = plt.subplots(
        figsize=(16, 8), dpi=500, subplot_kw={"projection": ccrs.PlateCarree()}
    )
