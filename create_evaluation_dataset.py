...
if __name__ == '__main__':
    ...
    '''
    all_data_vars = ['T', 'Td', 'sp_z', 'u', 'v', 'r', 'RH', 'Tv', 'theta_e', 'q', 'theta', 'theta_v']
    ...
    if not os.path.isfile(dataset_props_file):
        ...
        for key in sorted(['front_types', 'variables', 'pressure_levels', 'num_dims', 'image_size', 'normalization_method',
            'front_dilation', 'domain', 'override_extent']):
